...
export const Route = createFileRoute("/_authenticated/debts")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Debts — Equilibrium" },
      { name: "twitter:description", content: "Track what you owe and what is owed to you, with running balances, repayments and per-debtor status across currencies." },
