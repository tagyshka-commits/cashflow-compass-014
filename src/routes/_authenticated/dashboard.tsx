...
export const Route = createFileRoute("/_authenticated/dashboard")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Dashboard — Equilibrium" },
      { name: "twitter:description", content: "Your Reality Map: net worth, available money, runway and financial health score, with your AI CFO on hand for every decision." },
