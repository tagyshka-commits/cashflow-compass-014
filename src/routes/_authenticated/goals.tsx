...
export const Route = createFileRoute("/_authenticated/goals")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Goals — Equilibrium" },
      { name: "twitter:description", content: "What you're building toward: goal progress, required daily and monthly savings, and AI coaching that adapts when life happens." },
