...
export const Route = createFileRoute("/_authenticated/accounts")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Accounts — Equilibrium" },
      { name: "twitter:description", content: "Every place your money exists: cash, bank accounts, cards, crypto and protected savings, balanced in one multi-currency ledger." },
